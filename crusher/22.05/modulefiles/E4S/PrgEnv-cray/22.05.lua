...
local root = "/gpfs/alpine/csc439/world-shared/E4S/ParaTools/22.05/PrgEnv-cray/spack"

prepend_path("MODULEPATH", "/gpfs/alpine/csc439/world-shared/E4S/ParaTools/22.05/PrgEnv-cray/spack/share/spack/lmod/cray-sles15-x86_64/Core")
...
elseif (mode() == "unload" or mode() == "purge") then
    ...
    remove_path("MODULEPATH", "/gpfs/alpine/csc439/world-shared/E4S/ParaTools/22.05/PrgEnv-cray/spack/share/spack/lmod/cray-sles15-x86_64/Core")
end
