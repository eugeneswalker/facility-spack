...
local root = "/gpfs/alpine/csc439/world-shared/E4S/ParaTools/22.05/PrgEnv-amd/spack"
...
elseif (mode() == "unload" or mode() == "purge") then
    ...
    remove_path("MODULEPATH", "/gpfs/alpine/csc439/world-shared/E4S/ParaTools/22.05/PrgEnv-amd/spack/share/spack/lmod/cray-sles15-x86_64/Core")
end
